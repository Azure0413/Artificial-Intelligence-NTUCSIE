...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        all_corner = (False, False, False, False)
        s = (self.startingPosition, all_corner)
        return s
    ...
    def isGoalState(self, state: Any):
        ...
        """
        "*** YOUR CODE HERE ***"
        boolean = state[1][0] and state[1][1] and state[1][2] and state[1][3]
        return boolean
        util.raiseNotDefined()
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not hitsWall:
                if nextState in self.corners:
                    if nextState == (self.walls.width-2, 1):
